...
namespace LagendaBackend.Migrations
{
    ...
    [Migration("20210402052222_AddFileUpload")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LagendaBackend.Data.Models.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<DateTimeOffset>("DatetimeUploadedUtc")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("LagendaBackend.Data.Models.File", b =>
                {
                    b.HasOne("LagendaBackend.Data.Models.Profile", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("LagendaBackend.Data.Models.Image", b =>
                {
                    b.HasOne("LagendaBackend.Data.Models.File", "File")
                        .WithMany()
